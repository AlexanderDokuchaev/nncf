...
BIG_PRUNING_MODEL_TEST_PARAMS_VALUES = [
    (
        ...
        True,
        {
            1: gen_ref_masks([(8, 8), (16, 16), (32, 32), (64, 64)]),
    ...
    (
        ...
        True,
        {
            1: gen_ref_masks([(2, 14), (2, 30), (29, 35), (87, 41)]),
    ...
    (
        ...
        False,
        {
            1: gen_ref_masks([(16, 16), (32, 32), (64, 64)]),
    ...
    (
        ...
        False,
        {
            1: gen_ref_masks([(1, 31), (27, 37), (84, 44)]),
    ...
    (
        ...
        True,
        {
            1: gen_ref_masks([(2, 14), (4, 28), (31, 33), (93, 35)]),
    ...
    (
        ...
        False,
        {
            1: gen_ref_masks([(4, 28), (32, 32), (93, 35)]),
...
BigPruningTestModelRef = {
    0: {
        "next_nodes": BigPruningTestModelNextNodesRef,
...
PruningTestModelBroadcastedLinearRefs = {
    "next_nodes": {
        0: [
            {"node_name": "PruningTestModelBroadcastedLinear/NNCFLinear[last_linear]/linear_0", "sparse_multiplier": 64}
        ],
        1: [
            {"node_name": "PruningTestModelBroadcastedLinear/NNCFLinear[linear1]/linear_0", "sparse_multiplier": 64},
...
PruningTestModelBroadcastedLinearWithConcatRefs = {
    "next_nodes": {
        0: [
            {
                "node_name": "PruningTestModelBroadcastedLinearWithConcat/NNCFLinear[last_linear]/linear_0",
                "sparse_multiplier": 64,
            }
        ],
        1: [
            {
                "node_name": "PruningTestModelBroadcastedLinearWithConcat/NNCFLinear[linear1]/linear_0",
                "sparse_multiplier": 64,
            },
            {
...
PruningTestModelConcatWithLinearRefs = {
    "next_nodes": {
        0: [
            {"node_name": "PruningTestModelConcatWithLinear/NNCFConv2d[conv2]/conv2d_0", "sparse_multiplier": 1},
...
PruningTestBatchedLinearRef = {
    "next_nodes": {},
    "num_of_sparse_by_node": {},
    "pruned_in_channels": {
        "PruningTestBatchedLinear/NNCFConv2d[first_conv]/conv2d_0": 1,
        "PruningTestBatchedLinear/NNCFLinear[linear1]/linear_0": 8,
        "PruningTestBatchedLinear/NNCFLinear[last_linear]/linear_0": 4096,
    },
    "pruned_out_channels": {
        "PruningTestBatchedLinear/NNCFConv2d[first_conv]/conv2d_0": 32,
...
PruningTestModelDiffChInPruningClusterRef = {
    "next_nodes": {
        0: [
            {"node_name": "PruningTestModelDiffChInPruningCluster/NNCFConv2d[conv1]/conv2d_0", "sparse_multiplier": 1},
            {
    ...
    "pruned_in_channels": {
        "PruningTestModelDiffChInPruningCluster/NNCFConv2d[first_conv]/conv2d_0": 1,
    ...
    "pruned_out_channels": {
        "PruningTestModelDiffChInPruningCluster/NNCFConv2d[first_conv]/conv2d_0": 8,
...
@pytest.mark.parametrize(
    ("model_module", "all_weights", "pruning_flops_target", "ref_flops", "ref_params_num", "refs"),
    [
