...
GROUP_PRUNING_MODULES_TEST_CASES = [
    GroupPruningModulesTestStruct(
        ...
        non_pruned_module_nodes=[
            "PruningTestModelEltwise/NNCFConv2d[conv1]/conv2d_0",
            "PruningTestModelEltwise/NNCFConv2d[conv4]/conv2d_0",
        ],
        pruned_groups=[
            ["PruningTestModelEltwise/NNCFConv2d[conv2]/conv2d_0", "PruningTestModelEltwise/NNCFConv2d[conv3]/conv2d_0"]
        ],
        pruned_groups_by_node_id=[[3, 4]],
        can_prune_after_analysis={0: True, 1: False, 2: True, 3: True, 4: True, 5: True, 6: True, 7: True, 8: True},
        final_can_prune={
            1: PruningAnalysisDecision(False, [PruningAnalysisReason.CLOSING_CONV_MISSING]),
    ...
    GroupPruningModulesTestStruct(
        ...
        final_can_prune={
            1: PruningAnalysisDecision(True),
            3: PruningAnalysisDecision(True),
            4: PruningAnalysisDecision(True),
            7: PruningAnalysisDecision(False, [PruningAnalysisReason.LAST_CONV]),
        },
    ...
    GroupPruningModulesTestStruct(
        model=partial(ResidualConnectionModel, last_layer_accept_pruning=False),
        name="ResidualConnectionModel with not pruned last layer",
        non_pruned_module_nodes=[
            "ResidualConnectionModel/NNCFLinear[linear]/linear_0",
            "ResidualConnectionModel/NNCFConv2d[conv4]/conv2d_0",
            "ResidualConnectionModel/NNCFConv2d[conv5]/conv2d_0",
        ],
        pruned_groups=[
            [
                "ResidualConnectionModel/NNCFConv2d[conv1]/conv2d_0",
        ...
        final_can_prune={
            ...
            2: PruningAnalysisDecision(True),
            4: PruningAnalysisDecision(True),
            7: PruningAnalysisDecision(False, [PruningAnalysisReason.DIMENSION_MISMATCH]),
            8: PruningAnalysisDecision(False, [PruningAnalysisReason.DIMENSION_MISMATCH]),
            11: PruningAnalysisDecision(False, [PruningAnalysisReason.LAST_CONV]),
        },
        prune_params=(True, False),
    ),
    GroupPruningModulesTestStruct(
    ...
    GroupPruningModulesTestStruct(
        ...
        pruned_groups=[
            [
                "EltwiseCombinationModel/NNCFConv2d[conv1]/conv2d_0",
    ...
    GroupPruningModulesTestStruct(
        model=PruningTestModelSharedConvs,
        non_pruned_module_nodes=[
            "PruningTestModelSharedConvs/NNCFConv2d[conv1]/conv2d_0",
            "PruningTestModelSharedConvs/NNCFConv2d[conv3]/conv2d_0",
            "PruningTestModelSharedConvs/NNCFConv2d[conv3]/conv2d_1",
        ],
        pruned_groups=[
            [
                "PruningTestModelSharedConvs/NNCFConv2d[conv2]/conv2d_0",
    ...
    GroupPruningModulesTestStruct(
        model=DepthwiseConvolutionModel,
        non_pruned_module_nodes=[
            "DepthwiseConvolutionModel/NNCFConv2d[conv1]/conv2d_0",
            "DepthwiseConvolutionModel/NNCFConv2d[conv4]/conv2d_0",
        ],
        pruned_groups=[
            [
                "DepthwiseConvolutionModel/NNCFConv2d[conv2]/conv2d_0",
        ...
        can_prune_after_analysis={0: True, 1: False, 2: True, 3: True, 4: True, 5: True, 6: True, 7: True},
        final_can_prune={
            1: PruningAnalysisDecision(False, [PruningAnalysisReason.CLOSING_CONV_MISSING]),
            2: PruningAnalysisDecision(True),
            3: PruningAnalysisDecision(True),
    ...
    GroupPruningModulesTestStruct(
        ...
        non_pruned_module_nodes=[
            "MultipleDepthwiseConvolutionModel/NNCFConv2d[conv1]/conv2d_0",
    ...
    GroupPruningModulesTestStruct(
        model=NASnetBlock,
        non_pruned_module_nodes=[
            "NASnetBlock/NNCFConv2d[first_conv]/conv2d_0",
    ...
    GroupPruningModulesTestStruct(
        ...
        non_pruned_module_nodes=[
            "PruningTestModelWrongDimsElementwise/NNCFConv2d[first_conv]/conv2d_0",
        ...
        final_can_prune={
            1: PruningAnalysisDecision(False, PruningAnalysisReason.LAST_CONV),
    ...
    GroupPruningModulesTestStruct(
        ...
        final_can_prune={
            1: PruningAnalysisDecision(False, PruningAnalysisReason.DIMENSION_MISMATCH),
    ...
    GroupPruningModulesTestStruct(
        ...
        non_pruned_module_nodes=[
            "PruningTestModelWrongDims/NNCFConv2d[first_conv]/conv2d_0",
    ...
    GroupPruningModulesTestStruct(
        ...
        pruned_groups=[
            ["PruningTestModelSimplePrunableLinear/NNCFConv2d[conv]/conv2d_0"],
    ...
    GroupPruningModulesTestStruct(
        ...
        non_pruned_module_nodes=[
            "SplitMaskPropFailModel/NNCFConv2d[conv1]/conv2d_0",
    ...
    GroupPruningModulesTestStruct(
        ...
        non_pruned_module_nodes=[
            "SplitPruningInvalidModel/NNCFConv2d[conv1]/conv2d_0",
    ...
    GroupPruningModulesTestStruct(
        ...
        non_pruned_module_nodes=[],
        pruned_groups=[
            ["SplitConcatModel/NNCFConv2d[conv1]/conv2d_0"],
    ...
    GroupPruningModulesTestStruct(
        ...
        non_pruned_module_nodes=[
            "SplitReshapeModel/NNCFConv2d[conv1]/conv2d_0",
    ...
    GroupPruningModulesTestStruct(
        ...
        non_pruned_module_nodes=[],
        pruned_groups=[
            ["HRNetBlock/NNCFConv2d[conv1]/conv2d_0"],
    ...
    GroupPruningModulesTestStruct(
        model=PruningTestBatchedLinear,
        non_pruned_module_nodes=[
            "PruningTestBatchedLinear/NNCFConv2d[first_conv]/conv2d_0",
    ...
    GroupPruningModulesTestStruct(
        ...
        pruned_groups=[
            ["PruningTestModelBroadcastedLinearWithConcat/NNCFConv2d[first_conv]/conv2d_0"],
            [
    ...
    GroupPruningModulesTestStruct(
        ...
        pruned_groups_by_node_id=[[1]],
        can_prune_after_analysis={0: True, 1: True, 2: False, 3: True, 4: True, 5: False, 6: True, 7: True, 8: True},
        final_can_prune={
            1: PruningAnalysisDecision(True),
            2: PruningAnalysisDecision(False, PruningAnalysisReason.CLOSING_CONV_MISSING),
...
IS_MODULE_PRUNABLE_TEST_CASES = [
    ModulePrunableTestStruct(
        ...
        config_params={},
        is_module_prunable={
            "DiffConvsModel/NNCFConv2d[conv1]/conv2d_0": False,
    ...
    ModulePrunableTestStruct(
        ...
        is_module_prunable={
            "DiffConvsModel/NNCFConv2d[conv1]/conv2d_0": True,
            "DiffConvsModel/NNCFConv2d[conv2]/conv2d_0": True,
            "DiffConvsModel/NNCFConv2d[conv3]/conv2d_0": False,
            "DiffConvsModel/NNCFConv2d[conv4]/conv2d_0": False,
        },
    ...
    ModulePrunableTestStruct(
        ...
        config_params={},
        is_module_prunable={
            "BranchingModel/NNCFConv2d[conv1]/conv2d_0": False,
    ...
    ModulePrunableTestStruct(
        ...
        config_params={"prune_first_conv": True},
        is_module_prunable={
            "BranchingModel/NNCFConv2d[conv1]/conv2d_0": True,
    ...
    ModulePrunableTestStruct(
        ...
        config_params={"prune_first_conv": True},
        is_module_prunable={
            "ShuffleNetUnitModel/NNCFConv2d[conv]/conv2d_0": True,
    ...
    ModulePrunableTestStruct(
        ...
        is_module_prunable={
            "MultipleDepthwiseConvolutionModel/NNCFConv2d[conv1]/conv2d_0": False,
