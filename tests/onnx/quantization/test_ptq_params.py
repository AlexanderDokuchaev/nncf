...
class TestPTQParams(TemplateTestPTQParams):
    ...
    def test_params(self):
        return {
            "test_range_type_per_tensor": {"model": LinearModel().onnx_model, "stat_points_num": 5},
            "test_range_type_per_channel": {"model": OneDepthwiseConvolutionalModel().onnx_model, "stat_points_num": 2},
