...
def get_graph_desc(graph: NNCFGraph, include_fq_params: bool = False) -> Tuple[List[NodeDesc], List[EdgeDesc]]:
...
def save_for_netron(graph: NNCFGraph, save_path: str, graph_name: str = "Graph", include_fq_params: bool = False):
