...
class PropagationBasedQuantizerSetupGenerator(QuantizerSetupGeneratorBase):
    ...
    def generate_setup(self) -> SingleConfigQuantizerSetup:
        ...
        ignored_scopes_for_solver = str_or_list_to_list(self.ignored_scopes) + str_or_list_to_list(
            self._ignored_scopes_per_group[QuantizerGroup.ACTIVATIONS]
        )
...
class QuantizationBuilder(PTCompressionAlgorithmBuilder):
    ...
    def __init__(self, config, should_init: bool = True):
        ...
        self.hw_config = None
        self._legacy_single_config_quantizer_setup_from_comp_state = None  # type: Optional[SingleConfigQuantizerSetup]
