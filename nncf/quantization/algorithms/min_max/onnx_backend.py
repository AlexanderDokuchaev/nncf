...
class ONNXMinMaxAlgoBackend(MinMaxAlgoBackend):
    ...
    def minmax_statistic_collector(
        nncf_graph: NNCFGraph, target_point: ONNXTargetPoint, quantizer_config: QuantizerConfig, num_samples: int = None
    ...
    def mean_minmax_statistic_collector(
        ...
        return ONNXMeanMinMaxStatisticCollector(
            use_per_sample_stats, use_abs_max, reduction_shape, num_samples, window_size=None
        )
