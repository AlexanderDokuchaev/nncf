...
from typing import Dict, List, Optional, OrderedDict, TypeVar
...
class MinMaxQuantization(Algorithm):
    ...
    def _get_quantizer_setup(self, nncf_graph: NNCFGraph, pattern: GraphPattern) -> SingleConfigQuantizerSetup:
        ...
        model_type_ignore_scope = self._backend_entity.get_model_type_ignore_scope(
            model_type, self._parameters.target_device
        )
        ignored_names = set(
