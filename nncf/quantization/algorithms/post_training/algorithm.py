...
class PostTrainingQuantizationParameters(AlgorithmParameters):
    ...
    def __init__(
        ...
        bias_correction_algo = {BiasCorrection: BiasCorrectionParameters(number_samples=number_samples)}

        if fast_bias_correction:
            bias_correction_algo = {FastBiasCorrection: FastBiasCorrectionParameters(number_samples=number_samples)}
